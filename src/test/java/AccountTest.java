...
public class AccountTest {
  ...
  /*  @Test
    @DisplayName("Валдиные данные владельца проходят проверку")
    public void checkValidName() {
        String validName = "Иван Иванов";
        Account account = new Account(validName);
        MatcherAssert.assertThat(account.checkNameToEmboss(), is(true));
    }


    @Test
    @DisplayName("Данные без пробела между фамилией и именем не пройдут проверку")
    public void dataWithoutSpaceBetweenNamesReturnFalse(){
        String validName = "ИванИванов";
        Account account = new Account(validName);
        MatcherAssert.assertThat(account.checkNameToEmboss(), is(false));
    }

    @Test
    @DisplayName("Данные с пробелом в начале не пройдут проверку")
    public void dataWithSpaceAtStartReturnFalse(){
        String validName = " Иван Иванов";
        Account account = new Account(validName);
        MatcherAssert.assertThat(account.checkNameToEmboss(), is(false));
    }*/
